...
![Static Badge](https://img.shields.io/badge/node.js-grey?logo=nodedotjs) ![GitHub stars](https://img.shields.io/github/stars/Th3-C0der/anime-api?logo=github)
![GitHub forks](https://img.shields.io/github/forks/Th3-C0der/anime-api?logo=github)
...
# <p align="center">Th3-Anime API</p>

>

<p align="center">RestFul API made with Node.js <br/>(Checkout this anime streaming website  <a href="https://th3-anime.pages.dev" target="_blank">Th3-Anime</a> powered by this API)</p>
...
- [Documentation](#documentation)
  ...
  - [GET Anime Avatars](#get-anime-avatars)
  - [SCRAPE Anime Avatars](#scrape-anime-avatars)
...
```bash
$ git clone https://github.com/Th3-C0der/anime-api.git
$ cd anime-api
$ npm install
```

2. Refer the [.env.example](https://github.com/Th3-C0der/anime-api/blob/main/.env.example) file to setup `.env` file
...
[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Th3-C0der/anime-api)

### Render

Host your own instance of anime-api on Render.

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/Th3-Dev/Th3-Anime-API)
...
<p align="center" style="text-decoration: none;">Made by <a href="https://github.com/Th3-C0der" target="_blank">Th3-C0der</a>🫰</p>
...
```javascript
import axios from "axios";
const resp = await axios.get("/api/avatars");
console.log(resp.data);
```
...
```javascript
{
  ...
  "results": {
    "AttackOnTitan": [
      "/avatars/AttackOnTitan/20.jpg",
      ...
    ],
    "OnePiece": [
      "/avatars/OnePiece/user-00.jpeg",
      ...
    ]
  }
}
...
### `GET` Scrape Anime Avatars

```bash
  GET /api/avatars/scrape
```
...
> #### No parameter required ❌
> **Note**: This route is intended for one-time initialization to download images from the source to the local API storage.

#### Example of request

```javascript
import axios from "axios";
const resp = await axios.get("/api/avatars/scrape");
console.log(resp.data);
```
