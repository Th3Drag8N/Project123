...
export const createApiRoutes = (app, jsonResponse, jsonError) => {
  ...
  createRoute("/api/avatars", avatarController.getAvatars);
  createRoute("/api/avatar", avatarController.getAvatars);
  createRoute("/api/avatars/scrape", avatarController.scrapeAvatars);
};
